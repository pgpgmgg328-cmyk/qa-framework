...
# Подстроки, при которых кнопка НИКОГДА не считается кнопкой отправки ответа
# («Завершить смену», «Выйти», «Отправить на доработку» …)
FINISH_DENY_SUBSTRINGS: tuple[str, ...] = _env_list(
    "FINISH_DENY_SUBSTRINGS",
    ("смен", "сесси", "выйти", "выход", "logout", "работу", "аккаунт"),
)
